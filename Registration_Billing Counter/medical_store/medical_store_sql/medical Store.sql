...
delimiter |
CREATE TRIGGER delete_Staff BEFORE DELETE ON Staff
FOR EACH ROW
   BEGIN
     DELETE FROM Orders WHERE Staff_id = OLD.Staff_id;
   END;
 |
...
INSERT INTO Orders VALUES(10,'2017-08-22','MG10',60,71,1401,'Abbott India');
INSERT INTO Orders VALUES(10,'2017-08-22','MG10',76,85,154,'Alembic Pharma');
INSERT INTO Orders VALUES(10,'2017-08-22','MG10',78,23,560,'Sun Pharma');
